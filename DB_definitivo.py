...
# Inserimento Indexes
indexes = [
    ("PAT001", "2025-05-22", 8, 4.1, 95.2, 90.5),
    ("PAT001", "2025-05-23", 7, 3.5, 96.0, 89.0),
    ("PAT001", "2025-05-24", 6, 4.1, 95.0, 93.0),
    ("PAT001", "2025-05-25", 8, 4.0, 93.5, 89.7),
    ("PAT001", "2025-05-26", 10, 4.1, 95.2, 88.5),
