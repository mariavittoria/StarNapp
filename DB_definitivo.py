...
# Inserimento Indexes
indexes = [
    ("PAT001", "2025-05-22", 8, 5.1, 95.2, 92.5),
    ("PAT001", "2025-05-23", 7, 6.5, 97.0, 91.0),
    ("PAT001", "2025-05-24", 6, 3.1, 98.0, 93.0),
    ("PAT001", "2025-05-25", 8, 7.0, 93.5, 89.7),
    ("PAT001", "2025-05-26", 10, 9.1, 94.2, 88.5),
    ("PAT001", "2025-05-27", 10, 8.5, 95.6, 89.0),
    ("PAT001", "2025-05-28", 7, 6.1, 95.0, 90.0),
    ("PAT001", "2025-05-29", 12, 9.7, 93.5, 89.7),

    ("PAT011", "2025-05-25", 14, 8.7, 92.0, 89.3),
    ("PAT011", "2025-05-27", 8, 1.8, 96.5, 90.0),
    ("PAT011", "2025-05-28", 9, 0.7, 93.5, 90.0),
    ("PAT009", "2025-05-21", 10, 1.5, 92.5, 90.0),
    ("PAT009", "2025-05-22", 11.5, 1.5, 92.5, 90.0),
    ("PAT009", "2025-05-23", 12.5, 1.5, 93.5, 89.0),
    ("PAT009", "2025-05-24", 11.5, 1.5, 94.5, 90.0),
    ("PAT009", "2025-05-25", 10.3, 1.5, 96.5, 90.0),
    ("PAT009", "2025-05-26", 10.01, 1.5, 97.5, 90.0),
    ("PAT009", "2025-05-27", 8.7, 1.5, 96.5, 90.0),
    ("PAT009", "2025-05-28", 9, 1.5, 96.5, 90.0),
    ("PAT010", "2025-05-23", 6.4, 1.5, 97.5, 90.0),
    ("PAT010", "2025-05-24", 7, 1, 97.5, 90.0),
    ("PAT010", "2025-05-25", 3, 1.5, 97.0, 90.0),
    ("PAT010", "2025-05-26", 6, 7, 96.0, 90.0),
    ("PAT010", "2025-05-27", 6.5, 8, 96.5, 90.0),
    ("PAT010", "2025-05-28", 5, 15, 95.5, 90.0),
    ("PAT012", "2025-04-29", None, 1.5, 97.5, 90.0),
    ("PAT012", "2025-04-30", None, 2.0, 97.3, 91.5),
    ("PAT012", "2025-05-01", None, 1.8, 97.6, 90.2),
    ("PAT012", "2025-05-02", None, 2.1, 97.4, 91.9),
    ("PAT012", "2025-05-03", None, 1.7, 97.8, 91.0),
    ("PAT012", "2025-05-04", None, 2.3, 97.2, 93.0),
    ("PAT012", "2025-05-05", None, 1.9, 97.7, 90.5),
    ("PAT012", "2025-05-06", None, 1.6, 97.9, 90.8),
    ("PAT012", "2025-05-07", None, 2.0, 97.3, 94.7),
    ("PAT012", "2025-05-08", None, 2.2, 97.1, 95.5),
    ("PAT012", "2025-05-09", None, 1.4, 98.0, 95.2),
    ("PAT012", "2025-05-10", None, 2.1, 97.5, 93.3),
    ("PAT012", "2025-05-11", None, 1.8, 97.6, 93.0),
    ("PAT012", "2025-05-12", None, 2.0, 97.4, 94.6),
    ("PAT012", "2025-05-13", None, 1.5, 97.9, 95.1),
    ("PAT012", "2025-05-14", None, 2.4, 97.0, 95.7),
    ("PAT012", "2025-05-15", None, 1.7, 97.7, 91.3),
    ("PAT012", "2025-05-16", None, 2.2, 97.3, 94.2),
    ("PAT012", "2025-05-17", None, 1.6, 97.8, 91.7),
    ("PAT012", "2025-05-18", None, 2.1, 97.5, 93.9),
    ("PAT012", "2025-05-19", None, 1.9, 97.6, 93.6),
    ("PAT012", "2025-05-20", None, 1.8, 97.7, 95.4),
    ("PAT012", "2025-05-21", None, 2.3, 97.2, 96.1),
    ("PAT012", "2025-05-22", None, 1.5, 97.9, 91.0),
    ("PAT012", "2025-05-23", None, 2.0, 97.4, 92.8),
    ("PAT012", "2025-05-24", None, 2.1, 97.3, 94.4),
    ("PAT012", "2025-05-25", None, 1.6, 97.8, 90.9),
    ("PAT012", "2025-05-26", None, 1.9, 97.6, 90.2),
    ("PAT012", "2025-05-27", None, 2.0, 97.5, 92.5),
    ("PAT012", "2025-05-28", None, 1.7, 97.7, 90.3),
    ("PAT012", "2025-05-29", None, 2.2, 97.2, 95.8)
]
...
questionnaires = [
    ("PAT010", "2025-05-25", 2, 1, "CPAP noise kept me awake", 0, 0, 0, 0, 0, 1, "None", 0, "", 1, "72"),
    ("PAT010", "2025-05-26", 0, 1, "", 1, 1, 0, 1, 0, 1, "None", 0, "", 1, "75"),
